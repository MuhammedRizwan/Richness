    ...
    return (
        <div className="bg-orange-100 w-full py-16 font-serif">
            <div className="w-11/12 md:w-4/5 mx-auto flex flex-col md:flex-row items-center gap-10">
                {/* Image */}
                <div
                    className="w-3/4 md:w-1/2 h-[450px] md:h-[600px] bg-cover bg-center relative flex items-end justify-center px-6 md:px-12"
                    style={{
                ...
                >
                    ...
                    <div className="relative z-10 max-w-3xl text-white text-center md:text-left">
                        <h2 className="text-sm md:text-xl font-semibold leading-relaxed italic">
                        ...
                        <span className="mt-4 mx-2 text-md md:text-lg font-semibold tracking-wide text-yellow-400">– Mr TP SHOWKHATH</span>
                        </h2>
                    </div>
                </div>
                ...
                <div className="w-2/3 md:w-1/2 text-center md:text-left">
                    <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-2">The Visionary</h2>
                    <h3 className="text-xl md:text-2xl font-semibold text-yellow-300 mb-4">The Business Transformation Guru</h3>
                    ...
                    <button className="px-6 py-3 bg-yellow-300 text-black font-semibold rounded-full hover:bg-yellow-500 transition">
                        Be Inspired →
                    </button>
                </div>
            </div>
